...
# [1] https://gitee.com/zkat/supports-hyperlinks
...
supports_hyperlinks() {
  ...
  # https://gitee.com/ohmyzsh/ohmyzsh/issues/10964
...
# Source: https://gist.gitee.com/XVilka/8346728
supports_truecolor() {
  case "$COLORTERM" in
...
EOF
  ...
  # else
   sudo chsh -s "$zsh" "$USER"          # run chsh normally
  # fi
